...
const AttrsMenu = ({ node, id, onChange }) => {
  ...
  return (
    <div id="attrs-menu" className="d-flex align-items-center px-3 py-2">
      ...
      {id && (
        <div className="d-flex flex-column">
          <div className="d-flex flex-row mb-2">
            <div className="text-white d-flex align-items-center bg-transparent shadow-0 px-0 me-3">
              ...
              <MDBInput
                ...
                type="number"
                value={Math.round(element?.attrs.relativeX) || 0}
                onChange={(e) => {
                  updateAttributes({
            ...
            <div className="text-white d-flex align-items-center bg-transparent shadow-0 px-0 me-3">
              ...
              <MDBInput
                className="text-white"
                type="number"
                value={Math.round(element?.attrs.relativeY) || 0}
                onChange={(e) => {
                  updateAttributes({
            ...
            <div className="text-white d-flex align-items-center bg-transparent shadow-0 px-0 me-3">
              ...
              <MDBInput
                className="text-white"
                type="number"
                value={(element?.attrs.type === 'circle' ? Math.round(element?.attrs.radiusX) : element?.attrs.type === 'image' ? Math.round(element?.attrs.width * element?.attrs.scaleX) : Math.round(element?.attrs.width))  || 0}
                onChange={(e) => {
                  let newVal = {};
            ...
            <div className="text-white d-flex align-items-center bg-transparent shadow-0 px-0 me-3">
              ...
              <MDBInput
                className="text-white"
                type="number"
                value={(element?.attrs.type === 'circle' ? Math.round(element?.attrs.radiusY) : element?.attrs.type === 'image' ? Math.round(element?.attrs.height * element?.attrs.scaleY) : Math.round(element?.attrs.height)) || 0}
                onChange={(e) => {
                  let newVal = {};
                  switch (element?.attrs.type) {
                    case 'circle':
          ...
          {element?.attrs.type === 'rectangle' &&
            <SquareAttributes element={element} updateAttribute={updateAttribute}/>}
